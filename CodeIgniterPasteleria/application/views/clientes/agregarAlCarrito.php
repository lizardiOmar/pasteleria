...
<body class="bg-secondary">
	<?php
		...
		echo form_open("agregarAlCarritoCliente/{$idPedido}/{$clienteID}/{$producto['ID']}");
	?>
	<div class="bg-secondary-50 w-50 h-50 p-3 rounded mx-auto bg-gradient">
		<div class="form-text fw-bold text-white text-center form-group">
			...
			<div class="row">
				...
				<div class="col">
					<input class="form-control" placeholder="<?php echo $producto['cantidad']; ?>" name="cantidad" type="number" min="1" max="<?php echo $producto['cantidad']; ?>" onkeydown="return false" autofocus>
				</div>
			</div>
			<div class="row">
				<div class="col">
					<a class="text-white nav-link btn btn-danger btn-lg"href="http://localhost/CodeigniterPasteleria/index.php/compra/<?php echo $clienteID.'/'.$idPedido;?>">Cancelar</a>
				</div>
