...
<div class="row">
	...
	<div class="card bg-secondary mx-auto border border-primary border-3 rounded" style="width: 18rem;">
		...
		<a type="button" class="btn btn-primary btn-lg" href="http://localhost/CodeigniterPasteleria/index.php/agregarAlCarrito/<?php echo $idPedido;?>/<?php echo $cajero['ID']?>/<?php echo $producto['id']?>">Agregar</a>		
	</div>
	<?php endforeach;?>
</div>