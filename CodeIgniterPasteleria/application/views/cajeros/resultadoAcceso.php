...
<body class="bg-secondary">
    <div class="bg-secondary-50 w-50 h-50 p-3 rounded mx-auto bg-gradient">
		<div class="form-text fs-1 fw-bold text-white text-center form-group">
			<div class="h-25 form-text fs-1 fw-bold text-white-50 text-center">Punto de venta activo</div>
			<div class="row fs-3">
			...
			<div class="row align-items-center bg-primary">
				<a class="nav-link text-white" href="http://localhost/CodeigniterPasteleria/index.php/caja/<?php echo $usuario['ID']; ?>">Continuar</a>
			</div>
		</div>
	</div>
</body>