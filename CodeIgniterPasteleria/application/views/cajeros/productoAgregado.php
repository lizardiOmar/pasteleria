<head>
    <meta charset="utf-8">
    <title>Producto agregado a la venta.</title>
...
<body class="bg-secondary">
    <div class="bg-secondary-50 w-50 h-50 p-3 rounded mx-auto bg-gradient">
		<div class="form-text fs-1 fw-bold text-white text-center form-group">
			...
			<div class="col">
					<a class="text-white nav-link btn btn-danger btn-lg"href="http://localhost/CodeigniterPasteleria/index.php/venta/<?php echo $cajeroID.'/'.$pedido['ID'];?>">Continuar</a>
			</div>
		</div>
	</div>
</body>