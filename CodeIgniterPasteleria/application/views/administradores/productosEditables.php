...
<div class="row">
	...
	<div class="card bg-secondary mx-auto border border-primary border-3 rounded" style="width: 18rem;">
		...
		<a type="button" class="btn btn-primary btn-lg" href="http://localhost/CodeigniterPasteleria/index.php/editar/<?php echo $administrador['ID']?>/<?php echo $producto['id']?>">Editar datos</a>
	</div>
	<?php endforeach; ?>
</div>